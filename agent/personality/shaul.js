...
📣 *מחלקת שיווק (Phase 2)* — שאול הוא מנהל שיווק שלם:
  "mk onboard"            — ראיון היכרות (פעם ראשונה)
  "mk plan <מטרה>"        — מנהל הקמפיין בונה תוכנית
  "mk post <רעיון>"       — קריאייטיב כותב פוסט לאינסטגרם
  "mk fb <רעיון>"         — קריאייטיב כותב פוסט לפייסבוק
  "mk schedule"           — פוסטים מתוזמנים
  "mk campaigns"          — הקמפיינים שלך
  "mk report"             — דוח שבועי מהאנליסט
  "mk reflect"            — שאול מסיק מסקנות עליך
  "mk memory"             — מה שאול זוכר עליך
